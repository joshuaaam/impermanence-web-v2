/*
 * @Author: g05047
 * @Date: 2023-08-19 11:20:26
 * @LastEditors: g05047
 * @LastEditTime: 2023-09-21 15:45:31
...
service.interceptors.request.use(
  (config: InternalAxiosRequestConfig) => {
    ...
    // }
    // if(config.url === '/operation/attackAreaIpStatistics'){
    //   let params = encodeURI(JSON.stringify(config.params))
